...
BACKGROUND_IMAGE="${PROJECT_DIR}/Resources/LittleSpudDmgBackground.png"
APP_DIR="${PROJECT_DIR}/build/Little Spud.app"
...
VOLUME_NAME="Install Little Spud ${VERSION_LABEL}"
DMG_NAME="LittleSpud-${VERSION_LABEL}.dmg"
...
ditto "${APP_DIR}" "${STAGING_DIR}/Little Spud.app"
ln -s /Applications "${STAGING_DIR}/Applications"
cp "${BACKGROUND_IMAGE}" "${STAGING_DIR}/.background/LittleSpudDmgBackground.png"
...
tell application "Finder"
  tell disk "${VOLUME_NAME}"
    ...
    set background picture of viewOptions to file ".background:LittleSpudDmgBackground.png"
    set position of item "Little Spud.app" of container window to {420, 265}
